...
class subject_condition extends condition {
    ...
    public function display_options() {
        global $DB, $OUTPUT;
        $tags = $DB->get_records_sql("SELECT * FROM {subject}");
        ...
        $context = [
            'subjectoptions' => $tagoptions
        ];

        echo $OUTPUT->render_from_template('block_test_creator/subject_condition', $context);
    }
}