 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class subtopic_condition extends condition {
    ...
    public function display_options() {
        global $DB, $OUTPUT;
        $tags = $DB->get_records_sql("SELECT * FROM {subtopic}");
        ...
        $context = [
            'subtopicoptions' => $tagoptions
        ];

        echo $OUTPUT->render_from_template('block_test_creator/subtopic_condition', $context);
    }
}