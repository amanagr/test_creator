...
class difficulty_condition extends condition {
    ...
    public function display_options() {
        global $DB, $OUTPUT;
        $needle = '';
        $tags = $DB->get_records_sql("SELECT * FROM {difficulty} WHERE level LIKE '%$needle%'");
        ...
        echo $OUTPUT->render_from_template('block_test_creator/difficulty_condition', $context);
    }
}